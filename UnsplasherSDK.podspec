#
#  Be sure to run `pod spec lint UnsplasherSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Adrián Bouza Correa" => "adboco@telefonica.net" }
  # Or just: s.author    = "Adrián Bouza Correa"
  # s.authors            = { "Adrián Bouza Correa" => "abouza@mobincube.com" }
  # s.social_media_url   = "http://twitter.com/Adrián Bouza Correa"
  ...
  s.source_files  = "Classes", "Unsplasher/**/*.swift"
